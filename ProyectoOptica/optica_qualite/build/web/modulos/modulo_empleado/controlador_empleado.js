...
export function setDetalleVisible() {
    ...
    const tbl = document.getElementById('tblEmpleadoCompleta');
...
export function mostrarDetalle(idEmpleado) {
    validarToken();
...
export function limpiarCampos() {
    ...
    document.getElementById("txtGenero").value = "Escoge una opción";
    ...
    document.getElementById("txtRol").value = "Escoge una opción";
